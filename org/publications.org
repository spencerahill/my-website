...
2. *Hill, Spencer A.*, Simona Bordoni, and Jonathan L. Mitchell.  "Dynamical
   ...
   macroturbulent atmosphere."  In revision, /Journal of the Atmospheric
...
3. Mitchell, Jonathan L. and *Spencer A. Hill*.  "Constraints from invariant
   ...
   downdraft width with rotation rate."  In revision, /Journal of the
   Atmospheric Sciences/.  [[https://arxiv.org/abs/1911.05860]].
   {{{LINK("papers/mitchell-hill-2020-jas-resubmitted.pdf", PDF.)}}}
** Peer-reviewed
