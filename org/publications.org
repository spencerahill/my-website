...
1. *Hill, Spencer A.*, Adam H. Sobel, Michela Biasutti, and Mark A. Cane.
   "Indian summer monsoon rainfall interannual variability: spatial signatures
   and teleconnections."  Under review, /Journal of Climate/.
   https://arxiv.org/abs/2104.12306.
   {{{LINK("papers/ensinoo-ismr-jjas_2col.pdf", PDF.)}}}
2. *Hill, Spencer A.*, Natalie J. Burls, Alexey Fedorov, and Timothy M. Merlis.
   ...
   In revision, /Journal of Climate/.  [[https://arxiv.org/abs/2012.09228]].
...
1. *Hill, Spencer A.*, Simona Bordoni, and Jonathan L. Mitchell.  "Solsticial
   Hadley Cell ascending edge theory from supercriticality."  Accepted, /Journal
   of the Atmospheric Sciences/.  doi: [[https://doi.org/10.1175/JAS-D-20-0341.1]].
   {{{LINK("papers/had-cell-supercrit_accepted.pdf", PDF.)}}}
