...
syntax.  I use the [[http://ipython.org/][IPython]] environment and rely on the [[http://xarray.pydata.org][xarray]], [[http://www.numpy.org/][NumPy]], [[http://scipy.org/][SciPy]], and
[[http://matplotlib.org/][matplotlib]] modules to analyze climate model data via the free [[https://store.continuum.io/cshop/anaconda/][Anaconda]]
distribution.
