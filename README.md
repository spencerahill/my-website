# Source code for my academic websit
This repository comprises the source code I use to generate [my academic website](http://people.atmos.ucla.edu/shill).  I write the website as a set of [Emacs org-mode](http://orgmode.org/) files, and then use org's [publishing](http://orgmode.org/manual/Publishing.html) capabilities to generate the HTML.
...
# Contents
* If you're looking for the rendered version of my website, visit it at http://people.atmos.ucla.edu/shill.
...
# Publishing to HTML and/or LaTeX/PDF from .org yourself
